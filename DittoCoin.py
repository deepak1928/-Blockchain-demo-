...
class Blockchain:
    ...
    def is_chain_valid(self ,chain):
        ...
        while  block_index < len(chain):
            ...
            proof=block['proof']
            hash_operation=hashlib.sha256(str(proof**2 - previous_proof**2).encoded()).hexdigest()
...
#mining a block of a Blockchain
...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address ,receiver='alice',amount =111)
...
@app.route('/connect_nodes',methos =['POST'])
def connect_node():
    ...
    response={'message':'all nodes are connected.Our Blockchai n contains these node ',
